...
// Routes untuk barang - hanya form & aksi, jangan tampilkan daftar
...
// Block akses ke index barang (daftar tabel)
$route['barang'] = 'dashboard/index';
$route['barang/index'] = 'dashboard/index';
